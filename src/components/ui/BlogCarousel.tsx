      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 -ml-4">
            <button
              onClick={prevSlide}
              className="w-12 h-12 bg-white shadow-lg rounded-full flex items-center justify-center hover:bg-vibe-gray-50 transition-colors duration-200 border border-vibe-gray-200"
            >
                  ...
                  <div className="blog-card group cursor-pointer h-full">
                    ...
                    <div className="relative overflow-hidden rounded-t-2xl">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="bg-vibe-gradient text-white text-xs font-medium px-3 py-1 rounded-full">
                          {post.category}
                        </span>
                      </div>
                    </div>
