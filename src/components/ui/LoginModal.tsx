  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === "demo@vibewealth.com" && password === "password123") {
        ...
        setError(
          "Invalid email or password. Try demo@vibewealth.com / password123",
        );
      }
      setIsLoading(false);
    }, 1000);
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-vibe-purple-500 focus:border-transparent transition-all"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-vibe-purple-500 focus:border-transparent transition-all"
                        required
                      />
                      <button
                        type="button"
                ...
                <div className="mt-6 text-center">
                  <p className="text-gray-400">
                    ...
                    <button
                      ...
                      className="text-vibe-purple-400 hover:text-vibe-purple-300 font-medium transition-colors"
                    >
                      Sign Up
                    </button>
                  </p>
